...
import time
import traceback
from cenlight_generator import cenlight_generator
...
class cenlight_pipeline:
    ...
    def run(self, multi_process=False):
        ...
        cenlight_runner = cenlight_generator(self.dic_exp_conf,self.dic_agent_conf,self.dic_traffic_env_conf,self.dic_path)
        cenlight_runner.run()